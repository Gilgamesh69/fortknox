...
public class Mail_test {
	...
	public static void generateAndSendEmail() throws AddressException, MessagingException {
		String user = "logancollier04@gmail.com";
		// Step1
		...
		generateMailMessage.setSubject("Greetings from sybil..");
		String emailBody = "Test email by sybil JavaMail API example. " + "<br><br> Regards, <br>sybil Admin";
		...
		transport.connect("smtp.gmail.com", user, "toby200501540198");
